...
namespace WorldDomination.SimpleObservability.WebApi.Tests.Services;
...
public class HealthCheckServiceCamelCaseTests
{
    ...
    public void DeserializeHealthMetadata_WithPascalCaseJson_ShouldSucceed()
    {
        ...
        // Act.
        var metadata = JsonSerializer.Deserialize<HealthMetadata>(pascalCaseJson, options);
    ...
    public void DeserializeHealthMetadata_WithMinimalCamelCaseJson_ShouldSucceed()
    {
        ...
        // Act.
        var metadata = JsonSerializer.Deserialize<HealthMetadata>(minimalJson, options);
    ...
    public void DeserializeHealthStatus_WithCamelCaseString_ShouldSucceed()
    {
        ...
        // Act.
        var metadata = JsonSerializer.Deserialize<HealthMetadata>(json, options);
    ...
    public void DeserializeHealthMetadata_WithMixedCasing_ShouldSucceed()
    {
        ...
        // Act.
        var metadata = JsonSerializer.Deserialize<HealthMetadata>(mixedJson, options);
